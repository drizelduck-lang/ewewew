...
# ==========================================================
# ==========================================================
# HELPER FUNCTION: GENERATE SYNTHETIC FEATURES
# ==========================================================
def generate_synthetic_features(stats, seed):
    """
    Generates deterministic feature values from a random seed.
    Produces consistent feature vectors for the same seed.
    """
    random.seed(seed)
    ...
    for key, vals in stats.items():
        # Create a Gaussian-like variation around the mean
